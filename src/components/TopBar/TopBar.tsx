...
const TopBar: React.FC<Props> = () => {
  return (
    <div className="bg-dark-blue h-14 py-1 flex justify-between ">
      ...
      <div className = "md:w-96 md:bg-gray-700 flex items-center md:rounded-lg m-1">
        ...
        <input placeholder = "Search..." className = " hidden md:block bg-gray-700 w-full px-1 outline-none text-white"></input>
      </div>
      </div>
      <div className ="flex text-white px-3 items-center mr-5 ">
